...
repo --name="ManageIQ-Build" --baseurl=https://<%= ENV['ARTIFACTORY_USER'] %>:<%= ENV['ARTIFACTORY_TOKEN'] %>@na.artifactory.swg-devops.com/artifactory/hyc-bluecf-team-rpm-local/s390x/infrastructure-management-master-20260409161351/ --install
#%endif
...
# Network information
network --bootproto=dhcp --device=enc2e02 --onboot=on --noipv6 --activate
